...
abstract class BaseController
{
	...
	function __construct()
	{
		...
		$this->smarty->assign('site_name', t('site_name'));
		$this->smarty->assign('site_title', t('site_title'));

		$this->smarty->assign('menu_blog', t('menu_blog'));
		$this->smarty->assign('menu_contact', t('menu_contact'));
		$this->smarty->assign('menu_products', t('menu_products'));
		$this->smarty->assign('menu_database', t('menu_database'));
		$this->smarty->assign('menu_edit', t('menu_edit'));
		$this->smarty->assign('menu_search', t('menu_search'));
		$this->smarty->assign('menu_wiki', t('menu_wiki'));		
