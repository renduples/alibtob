...
/**
 * Auto generated Model Class represents table 'industries' 
 * @author: Thin PHP Framework
 * @date: 2011-08-28 20:13
 */
class Industrie extends BaseBO
{
	private $fields;
	private $id;
	...
	private function init($fields)
	{
		...
		if (isset($fields['industrytypeId'])) $this->industrytypeId = $fields['industrytypeId'];
	...
	public function setIndustrytypeId($industrytypeId) {
		$this->fields['industrytypeId'] = $industrytypeId;
	...
	{
		return ''.':'.$this->id.':'.$this->attachmentId.':'.$this->industrytypeId.':'.$this->childIds.':'.$this->name.':'.$this->url.':'.$this->aliasName.':'.$this->highlight.':'.$this->parentId.':'.$this->topParentid.':'.$this->level.':'.$this->displayOrder.':'.$this->description.':'.$this->available.':'.$this->created.':'.$this->modified;
	}
}
