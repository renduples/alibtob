...
/**
 * Auto generated Model Class represents table 'productcategories' 
 * @author: Thin PHP Framework
 * @date: 2011-08-28 20:13
 */
class Productcategorie extends BaseBO
{
	private $fields;
	private $id;
	private $parentId;
	...
	{
		return ''.':'.$this->id.':'.$this->parentId.':'.$this->level.':'.$this->name.':'.$this->displayOrder;
	}
}
